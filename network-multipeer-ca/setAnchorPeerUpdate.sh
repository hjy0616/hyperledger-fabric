...
#########################################################
####### set anchor peer0 for Org1 in the channel ########
#########################################################
...
#########################################################
####### set anchor peer1 for Org1 in the channel ########
#########################################################
...
infoln "Modify the configuration to append the anchor peer"
Modify the configuration to append the anchor peer 
jq '.channel_group.groups.Application.groups.Org1MSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer1.org1.example.com","port": 8051}]},"version": "0"}}' config.json > modified_config.json
{ set +x; } 2>/dev/null
...
#########################################################
####### set anchor peer0 for Org2 in the channel ########
#########################################################
...
#########################################################
####### set anchor peer1 for Org2 in the channel ########
#########################################################
...
infoln "Modify the configuration to append the anchor peer"
Modify the configuration to append the anchor peer 
jq '.channel_group.groups.Application.groups.Org2MSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer1.org2.example.com","port": 10051}]},"version": "0"}}' config.json > modified_config.json
{ set +x; } 2>/dev/null
