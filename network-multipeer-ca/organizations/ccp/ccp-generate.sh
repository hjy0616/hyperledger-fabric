...
P0PORT=7051
CAPORT=7054
PEERPEM=${NET_DIR_PATH}/peerOrganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem
CAPEM=${NET_DIR_PATH}/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem
...
P0PORT=9051
CAPORT=8054
PEERPEM=${NET_DIR_PATH}/peerOrganizations/org2.example.com/tlsca/tlsca.org2.example.com-cert.pem
CAPEM=${NET_DIR_PATH}/peerOrganizations/org2.example.com/ca/ca.org2.example.com-cert.pem
